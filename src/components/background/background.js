      ...
      <div className='background-page'>
        ...
        <section>
          <article>
            ...
            <p>
              I rigorously kept up with the ever-changing coding/policy changes to the CPT, HCPCS, 
              and ICD-10 code sets and <strong>drafted educational materials</strong> regarding 
              those changes for both clinical staff (including the Physician&apos;s) as well as 
              for the non-clinical staff such as our medical billers and other coding staff.
            </p>
          </article>
          <article>
